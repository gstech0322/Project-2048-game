...
const ScoreBoard = ({ total, title }) => {
    ...
    return (<Box marginInline="s2" paddingBlock="s3" paddingInline="s4" inlineSize="90px" background="secondary" flexDirection="column" position="relative" justifyContent="center" boxSizing="border-box">
